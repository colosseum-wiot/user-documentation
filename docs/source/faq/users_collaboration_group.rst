...
.. note::
    Users should use the same email address as registered in their Freshdesk account to request to join the Google Group, otherwise your request will be rejected.
